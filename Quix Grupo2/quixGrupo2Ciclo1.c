...
{
    r3=0;
    printf("\n\nPergunta número 2: Marque a alternativa(s) correta(s)\n\n");
    ...
    limpar_buffer();
    printf("\n\nVocê acha que a A está correta?envie (s) se você acha que é verdadeiro e (n) se acha que não\n");
    resposta = getchar();
    ...
    limpar_buffer();
    printf("\n\nVocê acha que a B está correta?envie (s) se você acha que é verdadeiro e (n) se acha que não\n");
    resposta = getchar();
    ...
    limpar_buffer();
    printf("\n\nVocê acha que a C está correta?envie (s) se você acha que é verdadeiro e (n) se acha que não\n");
    resposta = getchar();
    ...
    printf("d)	A memória cache está localizada internamente ao processador e é considerada a memória mais rápida após os registradores, sendo uma memória volátil.  \n");
     ...
     limpar_buffer();
    printf("\n\nVocê acha que a D está correta?envie (s) se você acha que é verdadeiro e (n) se acha que não\n");
    resposta = getchar();
    ...
    printf("e)	A memória cache possui 3 níveis de memória, é não volátil e está localizada dentro do processador. \n\n");
     ...
     limpar_buffer();
    printf("\n\nVocê acha que a E está correta?envie (s) se você acha que é verdadeiro e (n) se acha que não\n");
    resposta = getchar();
    ...
    printf("f)	A memória cache possui 3 níveis de memória, é volátil e está localizada fora do processador. \n\n");
     ...
     limpar_buffer();
    printf("\n\nVocê acha que a F está correta?envie (s) se você acha que é verdadeiro e (n) se acha que não\n");
    resposta = getchar();
    ...
    printf("g)	A memória cache possui 4 níveis de memória, é volátil e está localizada dentro do processador. \n\n");
     ...
     limpar_buffer();
    printf("\n\nVocê acha que a G está correta?envie (s) se você acha que é verdadeiro e (n) se acha que não\n");
    resposta = getchar();
  ...
  printf("h)    A memória cache possui 3 níveis de memória, é volátil e está localizada dentro do processador.   \n");
     ...
     limpar_buffer();
    printf("\n\nVocê acha que a H está correta?envie (s) se você acha que é verdadeiro e (n) se acha que não\n");
    resposta = getchar();
